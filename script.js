...
const textureLoader = new THREE.TextureLoader();
        ...
        //  // Material is a layer that will be added on the geometry
         var EARTHmaterial = new THREE.MeshBasicMaterial({transparent: true,opacity: 1,metalness: 0.3,roughness: 0.3, map: normalTexture});
         var SUNmaterial = new THREE.MeshBasicMaterial({transparent: true,opacity: 1,metalness: 0.3,roughness: 0, map: normalTextureSUN});
